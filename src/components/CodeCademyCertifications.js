...
import myImage from '../images//IMG_2301.jpg';
...
const CodeCademyCertifications = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">React.js Course</h3>
...
export default CodeCademyCertifications;
