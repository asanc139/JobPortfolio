...
import myImage3 from '../images//IMG_2303.jpg';
...
const Code3 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">Boostrap Course</h3>
