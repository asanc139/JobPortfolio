...
import myImage2 from '../images//IMG_2302.jpg';
...
const Code2 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">HTML Course</h3>
