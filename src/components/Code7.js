...
import myImage7 from '../images//IMG_2307.jpg';
...
const Code7 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">JavaScript Course</h3>
