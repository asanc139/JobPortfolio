...
import myImage14 from '../images//IMG_2314.jpg';
...
const Code14 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">React Router Course</h3>
        ...
        <div className="certContainer col-6 d-flex align-items-center justify-content-center">
          <img src={myImage14} alt="React.js" />
        </div>
      </div>
