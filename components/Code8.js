...
import myImage8 from '../images//IMG_2308.jpg';
...
const Code8 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3 className="codeCademyCerts">
            Building JavaScript Website Course
          </h3>
