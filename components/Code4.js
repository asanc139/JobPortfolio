...
import myImage4 from '../images//IMG_2304.jpg';
...
const Code4 = ({ technology, title, image, color, id }) => {
    ...
    >
      ...
      >
        <div className="textWrap col-6 d-flex flex-column justify-content-center align-items-center m-5">
          ...
          <h3
            className="codeCademyCerts"
            style={{ textOverflow: '-moz-initial' }}
          >
            Connecting Front-End to Back-End Coursse
          </h3>
